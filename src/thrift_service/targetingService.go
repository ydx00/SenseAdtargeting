...
type AdTargetingService interface {
  ...
  //  - BroadcasterId
  //  - RequestId
  Search(ctx context.Context, appId string, userId string, broadcasterId string, requestId string) (r string, err error)
  // Parameters:
  //  - AppId
  //  - UserId
  //  - BroadcasterId
  //  - AdMode
  //  - RequestId
  SearchV2(ctx context.Context, appId string, userId string, broadcasterId string, adMode int32, requestId string) (r string, err error)
  // Parameters:
  //  - AppId
  //  - UserId
  //  - RequestId
  Preload(ctx context.Context, appId string, userId string, requestId string) (r string, err error)
  // Parameters:
  //  - AppId
  //  - UserId
  //  - AdMode
  //  - RequestId
  PreloadV2(ctx context.Context, appId string, userId string, adMode int32, requestId string) (r string, err error)
  // Parameters:
  //  - AppId
  //  - Conditions
  UserCoverage(ctx context.Context, appId string, conditions string) (r int64, err error)
}
...
//  - BroadcasterId
//  - RequestId
func (p *AdTargetingServiceClient) Search(ctx context.Context, appId string, userId string, broadcasterId string, requestId string) (r string, err error) {
...
//  - AdMode
//  - RequestId
func (p *AdTargetingServiceClient) SearchV2(ctx context.Context, appId string, userId string, broadcasterId string, adMode int32, requestId string) (r string, err error) {
...
//  - UserId
//  - RequestId
func (p *AdTargetingServiceClient) Preload(ctx context.Context, appId string, userId string, requestId string) (r string, err error) {
...
//  - AdMode
//  - RequestId
func (p *AdTargetingServiceClient) PreloadV2(ctx context.Context, appId string, userId string, adMode int32, requestId string) (r string, err error) {
...
//  - AppId
//  - Conditions
func (p *AdTargetingServiceClient) UserCoverage(ctx context.Context, appId string, conditions string) (r int64, err error) {
...
func (p *AdTargetingServiceProcessor) Process(ctx context.Context, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
...
func (p *adTargetingServiceProcessorSearch) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  args := AdTargetingServiceSearchArgs{}
...
var retval string
  var err2 error
  if retval, err2 = p.handler.Search(ctx, args.AppId, args.UserId, args.BroadcasterId, args.RequestId); err2 != nil {
...
func (p *adTargetingServiceProcessorSearchV2) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  args := AdTargetingServiceSearchV2Args{}
  if err = args.Read(iprot); err != nil {
    iprot.ReadMessageEnd()
    x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
...
var retval string
  var err2 error
  if retval, err2 = p.handler.SearchV2(ctx, args.AppId, args.UserId, args.BroadcasterId, args.AdMode, args.RequestId); err2 != nil {
...
func (p *adTargetingServiceProcessorPreload) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  args := AdTargetingServicePreloadArgs{}
  if err = args.Read(iprot); err != nil {
    iprot.ReadMessageEnd()
    x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
...
var retval string
  var err2 error
  if retval, err2 = p.handler.Preload(ctx, args.AppId, args.UserId, args.RequestId); err2 != nil {
...
func (p *adTargetingServiceProcessorPreloadV2) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  args := AdTargetingServicePreloadV2Args{}
  if err = args.Read(iprot); err != nil {
    iprot.ReadMessageEnd()
    x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
...
var retval string
  var err2 error
  if retval, err2 = p.handler.PreloadV2(ctx, args.AppId, args.UserId, args.AdMode, args.RequestId); err2 != nil {
...
func (p *adTargetingServiceProcessorUserCoverage) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  args := AdTargetingServiceUserCoverageArgs{}
  if err = args.Read(iprot); err != nil {
    iprot.ReadMessageEnd()
    x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
...
var retval int64
  var err2 error
  if retval, err2 = p.handler.UserCoverage(ctx, args.AppId, args.Conditions); err2 != nil {
